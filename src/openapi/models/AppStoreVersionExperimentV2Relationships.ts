...
export function AppStoreVersionExperimentV2RelationshipsFromJSONTyped(json: any, ignoreDiscriminator: boolean): AppStoreVersionExperimentV2Relationships {
    ...
    return {
        ...
        'latestControlVersion': !exists(json, 'latestControlVersion') ? undefined : AppClipDefaultExperienceCreateRequestDataRelationshipsReleaseWithAppStoreVersionFromJSON(json['latestControlVersion']),
