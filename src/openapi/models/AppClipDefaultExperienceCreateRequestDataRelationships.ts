...
export function AppClipDefaultExperienceCreateRequestDataRelationshipsFromJSONTyped(json: any, ignoreDiscriminator: boolean): AppClipDefaultExperienceCreateRequestDataRelationships {
    ...
    return {
        ...
        'appClipDefaultExperienceTemplate': !exists(json, 'appClipDefaultExperienceTemplate') ? undefined : AppClipAppStoreReviewDetailRelationshipsAppClipDefaultExperienceFromJSON(json['appClipDefaultExperienceTemplate']),
    };
}
