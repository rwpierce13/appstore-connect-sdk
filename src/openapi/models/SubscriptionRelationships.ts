...
export function SubscriptionRelationshipsFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubscriptionRelationships {
    ...
    return {
        ...
        'pricePoints': !exists(json, 'pricePoints') ? undefined : AnalyticsReportInstanceRelationshipsSegmentsFromJSON(json['pricePoints']),
        ...
        'winBackOffers': !exists(json, 'winBackOffers') ? undefined : SubscriptionRelationshipsWinBackOffersFromJSON(json['winBackOffers']),
        'images': !exists(json, 'images') ? undefined : SubscriptionRelationshipsImagesFromJSON(json['images']),
    };
}
